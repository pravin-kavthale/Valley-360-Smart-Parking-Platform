...
const ParkingSlotForm = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-rose-100 via-orange-100 to-amber-200 flex items-center justify-center px-4 py-8">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-rose-200 shadow-md p-8 w-full max-w-4xl">
                <h2 className="text-2xl font-bold mb-6 text-center text-slate-900">Add Parking Slot</h2>
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label htmlFor="slotNumber" className="block text-sm font-medium text-slate-700">Slot Number</label>
                        <input
                            type="text"
                            id="slotNumber"
                            value={slotNumber}
                            ...
                            required
                            className="mt-1 block w-full px-3 py-2 border border-rose-200 rounded-md focus:outline-none focus:ring-2 focus:ring-rose-400"
                        />
                    </div>
